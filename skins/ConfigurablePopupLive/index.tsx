...
import styles from '../ConfigurablePopup/ConfigurablePopup.module.css'; // Use the same base CSS file!
...
// --- Helper Component for Content Blocks (Simplified for live) ---
...
// --- Main Production Skin Component ---
const ConfigurablePopupLiveSkin: React.FC<ConfigurablePopupProps> = ({ 
    ...
    // This component is nearly identical to ConfigurablePopup/index.tsx, 
    // but it exists in a separate file path which is crucial for bundling.
    ...
    const hasHeader = header?.title; // Only check for title now
    ...
    const containerStyle: React.CSSProperties = {
        ...
        // 2. Set CSS Variables for Width, Radius, and Shadow
        // @ts-ignore: We are intentionally setting CSS variables
        '--popup-max-width': POPUP_WIDTH_MAP[styling.popupWidth || 'medium'],
        // @ts-ignore
        '--popup-border-radius': `${styling.borderRadius || 8}px`,
        // @ts-ignore: Convert 0-100 percentage to 0.0-1.0 opacity
        '--popup-shadow-opacity': ((styling.boxShadowStrength || 3) / 100).toFixed(2),
    };
    ...
    // --- LOGIC: Determine container class ---
